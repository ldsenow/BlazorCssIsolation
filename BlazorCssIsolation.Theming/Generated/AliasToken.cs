...
namespace BlazorCssIsolation.Theming.Tokens
{
    ...
    public partial record AliasToken
    {
...

        {
            ...
            this.BoxShadowTertiary = @boxShadowTertiary;
        ...
        [System.Text.Json.Serialization.JsonPropertyName("boxShadowTertiary")]

        [System.Text.Json.Serialization.JsonIgnore(Condition = System.Text.Json.Serialization.JsonIgnoreCondition.Never)]   
        public string BoxShadowTertiary { get; init; }
        ...
        public static AliasToken FromJson(string data)
        {

            var options = new System.Text.Json.JsonSerializerOptions();

            return System.Text.Json.JsonSerializer.Deserialize<AliasToken>(data, options);
